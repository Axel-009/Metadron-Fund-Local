...
Usage:
    from openbb_data import (
        ...
        GICSSector, GICS_SECTORS, GICS_INDUSTRY_GROUPS,
        GICS_INDUSTRIES, GICS_SUB_INDUSTRIES,
    )

    df = get_historical("AAPL", start="2023-01-01", end="2024-01-01")
...
# Full GICS mapping: sector_code -> {name, groups}
GICS_SECTORS: Dict[str, Dict[str, Any]] = {
    ...
    "15": {"name": "Materials", "groups": {
        "1510": {"name": "Materials", "industries": {
            ...
            "151020": {"name": "Construction Materials", "sub_industries": {
    ...
    "20": {"name": "Industrials", "groups": {
        "2010": {"name": "Capital Goods", "industries": {
            "201010": {"name": "Aerospace & Defense", "sub_industries": {
                "20101010": "Aerospace & Defense",
            }},
            "201020": {"name": "Building Products", "sub_industries": {
                "20102010": "Building Products",
            }},
            "201030": {"name": "Construction & Engineering", "sub_industries": {
            ...
            "201050": {"name": "Industrial Conglomerates", "sub_industries": {
            ...
            "201070": {"name": "Trading Companies & Distributors", "sub_industries": {
        ...
        "2030": {"name": "Transportation", "industries": {
            "203010": {"name": "Air Freight & Logistics", "sub_industries": {
                "20301010": "Air Freight & Logistics",
            }},
            "203020": {"name": "Passenger Airlines", "sub_industries": {
                "20302010": "Passenger Airlines",
            }},
            "203030": {"name": "Marine Transportation", "sub_industries": {
    ...
    "25": {"name": "Consumer Discretionary", "groups": {
        "2510": {"name": "Automobiles & Components", "industries": {
            "251010": {"name": "Automobile Components", "sub_industries": {
                "25101010": "Automobile Parts & Equipment",
        ...
        "2520": {"name": "Consumer Durables & Apparel", "industries": {
            ...
            "252020": {"name": "Leisure Products", "sub_industries": {
        ...
        "2550": {"name": "Retailing", "industries": {
            "255010": {"name": "Distributors", "sub_industries": {
                "25501010": "Distributors",
            }},
            "255020": {"name": "Internet & Direct Marketing Retail", "sub_industries": {
            ...
            "255030": {"name": "Broadline Retail", "sub_industries": {
                ...
                "25503060": "Automotive Retail",
                "25504010": "Homefurnishing Retail",
            }},
            "255040": {"name": "Specialty Retail", "sub_industries": {
                "25504020": "Specialty Stores",
            }},
        }},
    }},
    "30": {"name": "Consumer Staples", "groups": {
        ...
        "3020": {"name": "Food, Beverage & Tobacco", "industries": {
            ...
            "302030": {"name": "Tobacco", "sub_industries": {
                "30203010": "Tobacco",
            }},
        }},
        "3030": {"name": "Household & Personal Products", "industries": {
            "303010": {"name": "Household Products", "sub_industries": {
                "30301010": "Household Products",
            }},
            "303020": {"name": "Personal Care Products", "sub_industries": {
    ...
    "35": {"name": "Health Care", "groups": {
        "3510": {"name": "Health Care Equipment & Services", "industries": {
            ...
            "351030": {"name": "Health Care Technology", "sub_industries": {
                "35103010": "Health Care Technology",
            }},
        }},
        "3520": {"name": "Pharmaceuticals, Biotechnology & Life Sciences", "industries": {
            "352010": {"name": "Biotechnology", "sub_industries": {
                "35201010": "Biotechnology",
            }},
            "352020": {"name": "Pharmaceuticals", "sub_industries": {
                "35202010": "Pharmaceuticals",
            }},
            "352030": {"name": "Life Sciences Tools & Services", "sub_industries": {
    ...
    "40": {"name": "Financials", "groups": {
        ...
        "4020": {"name": "Financial Services", "industries": {
            ...
            "402020": {"name": "Consumer Finance", "sub_industries": {
            ...
            "402040": {"name": "Mortgage Real Estate Investment Trusts", "sub_industries": {
    ...
    "45": {"name": "Information Technology", "groups": {
        "4510": {"name": "Software & Services", "industries": {
            "451010": {"name": "IT Services", "sub_industries": {
                "45101010": "IT Consulting & Other Services",
                "45101020": "Internet Services & Infrastructure",
            }},
            "451020": {"name": "Software", "sub_industries": {
                "45102010": "Application Software",
                "45102020": "Systems Software",
            }},
        }},
        "4520": {"name": "Technology Hardware & Equipment", "industries": {
            "452010": {"name": "Communications Equipment", "sub_industries": {
                "45201020": "Communications Equipment",
            }},
            "452020": {"name": "Technology Hardware, Storage & Peripherals", "sub_industries": {
    ...
    "50": {"name": "Communication Services", "groups": {
        "5010": {"name": "Telecommunication Services", "industries": {
            ...
            "501020": {"name": "Wireless Telecommunication Services", "sub_industries": {
        ...
        "5020": {"name": "Media & Entertainment", "industries": {
            ...
            "502030": {"name": "Interactive Media & Services", "sub_industries": {
    ...
    "55": {"name": "Utilities", "groups": {
        "5510": {"name": "Utilities", "industries": {
            "551010": {"name": "Electric Utilities", "sub_industries": {
                "55101010": "Electric Utilities",
            }},
            "551020": {"name": "Gas Utilities", "sub_industries": {
                "55102010": "Gas Utilities",
            }},
            "551030": {"name": "Multi-Utilities", "sub_industries": {
                "55103010": "Multi-Utilities",
            }},
            "551040": {"name": "Water Utilities", "sub_industries": {
    ...
    "60": {"name": "Real Estate", "groups": {
        "6010": {"name": "Equity Real Estate Investment Trusts (REITs)", "industries": {
            "601010": {"name": "Diversified REITs", "sub_industries": {
                "60101010": "Diversified REITs",
            }},
            "601025": {"name": "Industrial REITs", "sub_industries": {
                "60102510": "Industrial REITs",
            }},
            "601030": {"name": "Hotel & Resort REITs", "sub_industries": {
                "60103010": "Hotel & Resort REITs",
            }},
            "601040": {"name": "Office REITs", "sub_industries": {
                "60104010": "Office REITs",
            }},
            "601050": {"name": "Health Care REITs", "sub_industries": {
...
# Convenience flat lookups
GICS_INDUSTRY_GROUPS: Dict[str, str] = {}
GICS_INDUSTRIES: Dict[str, str] = {}
GICS_SUB_INDUSTRIES: Dict[str, str] = {}

for _sec_code, _sec in GICS_SECTORS.items():
    for _grp_code, _grp in _sec["groups"].items():
        GICS_INDUSTRY_GROUPS[_grp_code] = _grp["name"]
        for _ind_code, _ind in _grp["industries"].items():
            GICS_INDUSTRIES[_ind_code] = _ind["name"]
            for _sub_code, _sub_name in _ind["sub_industries"].items():
                GICS_SUB_INDUSTRIES[_sub_code] = _sub_name
...
# S&P 500 top 50 by market cap (representative)
...
# GICS sector -> representative ticker mapping for S&P 500 top 50
...
# Bonds -- government & corporate benchmark tickers
BOND_UNIVERSE: List[str] = [
    "TLT",   # iShares 20+ Year Treasury Bond ETF (proxy for long bond)
...
# ETF universe -- sector & thematic
ETF_UNIVERSE: List[str] = [
    "SPY", "QQQ", "IWM", "DIA", "VTI",  # Broad market
    "XLK", "XLF", "XLE", "XLV", "XLI",  # Sector SPDR
    "XLC", "XLY", "XLP", "XLB", "XLRE", "XLU",  # More sectors
...
def detect_asset_class(symbol: str) -> AssetClass:
    """
    Detect the asset class for a given ticker symbol.

    Heuristic priority:
      1. Check against hardcoded universe sets.
      2. Pattern-based detection (=F suffix -> commodity, -USD -> crypto, =X -> FX,
         ^ prefix -> index).
      3. Default to EQUITY.
...
def get_gics_classification(symbol: str) -> Optional[Dict[str, Any]]:
    """
    Return GICS classification for an equity symbol if available.

    Returns
    -------
    dict or None
        Keys: sector, industry_group, industry (with codes and names).
    """
...
# ---------------------------------------------------------------------------
# Full universe helpers
# ---------------------------------------------------------------------------

def get_full_universe() -> Dict[AssetClass, List[str]]:
    """Return the complete hardcoded universe keyed by asset class."""
    return {
...
def get_all_symbols() -> List[str]:
    """Return a flat list of every symbol in the universe."""
    symbols: List[str] = []
...
# ---------------------------------------------------------------------------
# OpenBB data access (SOLE source -- no yfinance)
# ---------------------------------------------------------------------------

def _openbb_route_for_asset(asset_class: AssetClass) -> str:
    """
    Return the appropriate OpenBB SDK route category for a given asset class.
    """
    _routes = {
        AssetClass.EQUITY: "equity",
        AssetClass.BOND: "fixedincome",
    ...
    return _routes.get(asset_class, "equity")
...
def get_historical(
    ...
    """
    Fetch historical OHLCV data for any symbol in the universe via OpenBB.

    OpenBB is the SOLE data source.  No yfinance fallback.

    Parameters
    ----------
    symbol : str
        Ticker symbol (any asset class).
    start : str, optional
    ...
    -------
    pd.DataFrame
        Normalised DataFrame with columns: Date, Open, High, Low, Close, Volume.

    Raises
    ------
    RuntimeError
        If OpenBB cannot fulfil the request.
    """
    if end is None:
    ...
    route = _openbb_route_for_asset(asset_class)

    logger.info(
        "Fetching %s (asset_class=%s) via OpenBB route=%s provider=%s",
        symbol, asset_class.value, route, provider,
    )
    ...
    try:
        if asset_class == AssetClass.CRYPTO:
            ...
            # Bond ETFs are fetched via equity route
            ...
            # Commodity futures fetched via equity route (exchange-traded)
            result = obb.equity.price.historical(
                symbol=symbol,
                start_date=start,
                end_date=end,
        ...
        raise RuntimeError(
            f"OpenBB failed for {symbol} (asset_class={asset_class.value}): {exc}"
        ) from exc
...
def get_multiple(
    ...
    symbols : list of str
    start, end, provider
        Passed through to :func:`get_historical`.
...
def get_fundamentals(
    ...
    """
    Fetch fundamental / company data via OpenBB.
    ...
    if asset_class != AssetClass.EQUITY:
        raise ValueError(
            f"Fundamentals are only available for equities, got {asset_class.value}"
        )
...
def get_universe_data(
    ...
    """
    Fetch historical data for the entire universe (or selected asset classes).

    Parameters
    ----------
    asset_classes : list of AssetClass, optional
        If None, fetches all asset classes.
    start, end, provider
        Passed through to :func:`get_historical`.
    ...
    -------
    dict
        symbol -> DataFrame for every successfully fetched symbol.
    """
    universe = get_full_universe()
    symbols: List[str] = []
...
if __name__ == "__main__":
    ...
    print("\n=== Asset Class Detection ===")
    test_symbols = ["AAPL", "TLT", "GC=F", "BTC-USD", "EURUSD=X", "^GSPC", "SPY"]
    for sym in test_symbols:
        ac = detect_asset_class(sym)
        print(f"  {sym} -> {ac.value}")

    print("\n=== GICS Classification ===")
    for sym in ["AAPL", "JPM", "XOM", "UNH", "NEE"]:
        gics = get_gics_classification(sym)
        if gics:
            print(f"  {sym}: {gics['sector_name']} / {gics['industry_group_name']} / {gics['industry_name']}")

    print("\n=== GICS Summary ===")
    print(f"  Sectors: {len(GICS_SECTORS)}")
    print(f"  Industry Groups: {len(GICS_INDUSTRY_GROUPS)}")
    print(f"  Industries: {len(GICS_INDUSTRIES)}")
    print(f"  Sub-Industries: {len(GICS_SUB_INDUSTRIES)}")
