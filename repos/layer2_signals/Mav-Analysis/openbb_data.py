...
no yfinance pool, no fallback.

Designed to complement the existing maverick_mcp data infrastructure.
...
GICS_SECTORS: Dict[str, Dict[str, Any]] = {
    ...
    "40": {"name": "Financials", "groups": {
        "4010": {"name": "Banks", "industries": {
            "401010": {"name": "Banks", "sub_industries": {"40101010": "Diversified Banks", "40101015": "Regional Banks"}},
        }},
    ...
    "45": {"name": "Information Technology", "groups": {
        "4510": {"name": "Software & Services", "industries": {
            ...
            "451020": {"name": "Software", "sub_industries": {"45102010": "Application Software", "45102020": "Systems Software"}},
        }},
...
# ---------------------------------------------------------------------------
# OpenBB data access (SOLE source -- no yfinance, no fallback)
# ---------------------------------------------------------------------------
...
def get_historical(
    ...
    -------
    pd.DataFrame
        Normalised with columns: Date, Open, High, Low, Close, Volume.
    """
    if end is None:
